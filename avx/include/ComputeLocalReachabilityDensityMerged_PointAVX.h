...
#ifndef FASTLOF_COMPUTELOCALREACHABILITYDENSITYMERGED_POINTUNROLLED_H
...
void verify_function_avx( int num_pts, int pnt_idx, int k, my_fun fun_to_verify );
...
#endif //FASTLOF_COMPUTELOCALREACHABILITYDENSITYMERGED_POINTUNROLLED_H
