...
int lof_driver_unrolled(int k_ref, int num_pts_ref) {
    ...
    */
    ...
    fun_array_lof[1] = &ComputeLocalOutlierFactor_1_unroll;
    fun_array_lof[2] = &ComputeLocalOutlierFactor_2_unroll;
    fun_array_lof[3] = &ComputeLocalOutlierFactor_3_unroll;
    fun_array_lof[4] = &ComputeLocalOutlierFactor_4_unroll;
    fun_array_lof[5] = &ComputeLocalOutlierFactorUnroll_Fastest;
    fun_array_lof[6] = &ComputeLocalOutlierFactor_6_unroll;
